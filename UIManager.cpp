...
UIManager::UIManager(HWND windowHandle)
{
    ...
    ToolBar* toolBar = new ToolBar("name");
    uiList.push_back(toolBar);

    SceneOutliner* sceneOutliner = new SceneOutliner("name");
    uiList.push_back(sceneOutliner);

    InspectorWindow* inspectorWindow = new InspectorWindow("name");
    uiList.push_back(inspectorWindow);

    EngineProfiler* engineProfiler = new EngineProfiler("name");
